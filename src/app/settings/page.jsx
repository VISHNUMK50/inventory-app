            ...
            <ul className="space-y-2">
              ...
              <li>
                <button
                  ...
                  className={`flex items-center w-full px-3 py-2 text-left rounded ${
                    activeTab === 'billing' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`flex items-center w-full px-3 py-2 text-left rounded ${
                    activeTab === 'company' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'
                  }`}
                >
              ...
              <li>
                <button
                  ...
                  className={`flex items-center w-full px-3 py-2 text-left rounded ${
                    activeTab === 'integrations' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'
                  }`}
                >
